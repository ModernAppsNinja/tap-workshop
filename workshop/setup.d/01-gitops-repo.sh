...
git remote add origin https://gitea_admin:$GITEA_PASSWORD@gitea.tanzu.demo:31132/gitea_admin/$REPO_NAME.git
git push -u origin main

cd ..
git clone https://gitea_admin:$GITEA_PASSWORD@gitea.tanzu.demo:31132/gitea_admin/gitops-workloads.git
...
git clone https://gitea_admin:$GITEA_PASSWORD@gitea.tanzu.demo:31132/gitea_admin/gitops-deliverables.git
